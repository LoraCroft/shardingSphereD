 ...
 * @date 2022/6/30 0:17
 */
public class LoraPreciseDBShardingAlgorithm implements PreciseShardingAlgorithm<Long> {
    /**
     *
     * 实现分片 策略
    ...
    public String doSharding(Collection<String> availableTargetNames, PreciseShardingValue<Long> shardingValue) {
        ...
        String key = "m"+"_"+ BigInteger.valueOf(value).mod(new BigInteger("2")).add(new BigInteger("1"));
